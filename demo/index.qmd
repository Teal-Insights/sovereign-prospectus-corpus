...
- Two appendices cover technical details and the broader SovTech concept

## Credits

Built by [Teal Insights](https://tealinsights.com) as part of the SovTech concept, with support from [NatureFinance](https://www.naturefinance.net/). Open source under the MIT license, available on [GitHub](https://github.com/Teal-Insights/sovereign-prospectus-corpus).
