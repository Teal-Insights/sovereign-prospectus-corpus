...
**A proposal for rapidly scaling the reach of [#PublicDebtIsPublic](https://publicdebtispublic.mdi.georgetown.edu/). Presented at the Infrastructure Scoping Roundtable, March 30, 2026, Georgetown University Law Center.**

Using PDIP's expert-annotated contracts as a foundation, this prototype collected **4,800+ sovereign bond prospectuses** from three public sources and identified **9,145 potential clause matches** across **59 countries**. Here is where those matches are:

```{python}
#| echo: false
#| fig-cap: "Countries with potential clause matches in the corpus. Darker shading indicates more matches found."
...
This prototype built steps 1 through 5. It pulled **4,800+ sovereign bond prospectuses** from three sources and found **9,145 potential clause matches** across 6 clause families covering **59 countries**. These are candidates, not validated findings. Steps 6 and 7 are what this roundtable can help make happen.
...
- **A First Peek at the Data** presents preliminary findings with interactive charts
- **The Lawyer-in-the-Loop Flywheel** describes how lawyers can validate extractions and improve the dataset
- **A Call for Collaboration** outlines what a durable version of this system would require
- Two appendices cover technical details and SovTech

## Credits

Built by [Teal Insights](https://tealinsights.com), which is creating an open source ecosystem for sovereign debt analysis (we call it SovTech), with support from [NatureFinance](https://www.naturefinance.net/). Open source under the MIT license, available on [GitHub](https://github.com/Teal-Insights/sovereign-prospectus-corpus).
