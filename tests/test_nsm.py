...
class TestDiscoverNsmSizeCeiling:
    ...
    def test_warns_when_query_hits_size_limit(self, tmp_path: Path) -> None:
        """A query returning exactly the page size triggers a warning."""
        import warnings
        ...
        mock_client = MagicMock()
        mock_response = MagicMock()
        # Return exactly 10000 hits to trigger the warning
